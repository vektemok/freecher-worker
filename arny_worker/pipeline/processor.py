...
from arny_worker.media.fingerprint import SourceFingerprint, compute_source_fingerprint
...
def run_pipeline(
    ...
    """Execute the arny-worker Phase 1.1 processing pipeline on a video file.
    ...
    logger.info("pipeline", f"Starting arny-worker run: {resolved_run_id} (version {PIPELINE_VERSION})")
